...
include "../../../../../src/fullballotvaliditycircuit/snarkfield/majorityJudgementComplete.circom";
...
template testMain(){
    ...
    component test = computeMajorityJudgementComplete(bitsVotes, nVotes, nGrades, N, n, k, comkey);

...
template testThresholdTallyLattice(bits,nVotes,N,q,n,k,comkey){
/**
 * Computes a commitment to a Single-Choice/Multiple-Choice/Borda tally and all candidates that met a threshold of votes/points.
 *
 *   Tally parameters:
 ...
 */
    ...
    component resfunc = computeMaximumIndicatorAtIdx(nVotes, bits);

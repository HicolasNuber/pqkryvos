...
template testLeastVotesTallyLattice(bits,nVotes,N,q,n,k,comkey){
/**
 * Computes a commitment to a Single-Choice/Multiple-Choice/Borda tally and the candidate(s) who received the least votes/points.
 *
 *   Tally parameters:
 ...
 */
    ...
    component resfunc = computeMinimumIndicator(nVotes, bits);

...
template testCondorcetSmithSetLattice(bits,nVotes,N,q,n,k,comkey){
/**
 ...
 */
    ...
    component computeSmithSet(nVotes, bits);
    computeSmithSet.tally <== tally;
    smithSet <== computeSmithSet.out;
